...
class __TwigTemplate_72efacf16bd87e22d577965be8bd348ecd5684d99231ecee2b0e99e20ebdb234 extends \Twig\Template
{
    public function __construct(Environment $env)
    {
        ...
        $tags = ["if" => 48, "set" => 50];
        $filters = ["clean_class" => 79, "escape" => 97];
        $functions = [];
...
($context["description_display"] ?? null) == "invisible")) ? ("sr-only") : (""))];
    ...
    ";
        ...
        ";
                // line 108
                echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["input_title"] ?? null)), "html", null, true);
                echo "
      </label>
    ";
            }
...
{% else %}
  ...
  <!--</fieldset>-->
{% endif %}
", "themes/bootstrap_barrio/templates/form/form-element.html.twig", "/var/www/web/themes/bootstrap_barrio/templates/form/form-element.html.twig");
    }
}
