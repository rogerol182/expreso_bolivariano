...
namespace Drupal\forcontu_pages\Plugin\HttpServiceApiWrapper;

use Drupal\http_client_manager\Plugin\HttpServiceApiWrapper\HttpServiceApiWrapperBase;
use Drupal\forcontu_pages\api\Commands\Services;
...
class HttpServiceApiWrapperServices extends HttpServiceApiWrapperBase {
  ...
  public function getHttpClient() {
    return $this->httpClientFactory->get('forcontu_services_yaml');
  }
