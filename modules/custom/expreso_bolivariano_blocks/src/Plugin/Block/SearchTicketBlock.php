...
/**
* @file
* Contains \Drupal\expreso_bolivariano_blocks\Plugin\Block\SearchTicketBlock.
*/
...
/**
 * Provides a 'Search Ticket Block' block.
 *
 * @Block(
 *   id = "Search Ticket Block",
 *   admin_label = @Translation("Search Ticket Block"),
 *
 * )
 */

class SearchTicketBlock extends BlockBase implements ContainerFactoryPluginInterface {
