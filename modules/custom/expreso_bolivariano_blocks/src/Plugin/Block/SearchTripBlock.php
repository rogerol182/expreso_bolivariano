...
/**
* @file
* Contains \Drupal\expreso_bolivariano_blocks\Plugin\Block\SearchTripBlock.
*/
...
/**
 * Provides a 'Search trip Block' block.
 *
 * @Block(
 *   id = "Search Trip Block",
 *   admin_label = @Translation("Search Trip Block"),
 *
 * )
 */

class SearchTripBlock extends BlockBase implements ContainerFactoryPluginInterface {
