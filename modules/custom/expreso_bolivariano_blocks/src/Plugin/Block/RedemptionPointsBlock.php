...
/**
* @file
* Contains \Drupal\expreso_bolivariano_blocks\Plugin\Block\RedemptionsPointsBlock.
*/
...
/**
 * Provides a 'Redemption Points Block' block.
 *
 * @Block(
 *   id = "Redemption Points Block",
 *   admin_label = @Translation("Redemption Points Block"),
 *
 * )
 */

class RedemptionPointsBlock extends BlockBase implements ContainerFactoryPluginInterface {
